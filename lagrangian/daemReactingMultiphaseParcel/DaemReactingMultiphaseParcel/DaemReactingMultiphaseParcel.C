...
const Foam::label Foam::DaemReactingMultiphaseParcel<ParcelType>::GAS(0);

template<class ParcelType>
const Foam::label Foam::DaemReactingMultiphaseParcel<ParcelType>::LIQ(1);

template<class ParcelType>
const Foam::label Foam::DaemReactingMultiphaseParcel<ParcelType>::SLD(2);
...
Foam::scalar Foam::DaemReactingMultiphaseParcel<ParcelType>::CpEff
(
    TrackData& td,
    const scalar p,
    const scalar T,
...
template<class ParcelType>
template<class TrackData>
Foam::scalar Foam::DaemReactingMultiphaseParcel<ParcelType>::HsEff
(
    TrackData& td,
    const scalar p,
    const scalar T,
...
template<class ParcelType>
template<class TrackData>
Foam::scalar Foam::DaemReactingMultiphaseParcel<ParcelType>::LEff
(
    TrackData& td,
    const scalar p,
    const scalar T,
...
template<class ParcelType>
Foam::scalar Foam::DaemReactingMultiphaseParcel<ParcelType>::updateMassFractions
(
    const scalar mass0,
...
template<class ParcelType>
template<class TrackData>
void Foam::DaemReactingMultiphaseParcel<ParcelType>::setCellValues
(
    TrackData& td,
    const scalar dt,
    const label celli
...
template<class ParcelType>
template<class TrackData>
void Foam::DaemReactingMultiphaseParcel<ParcelType>::cellValueSourceCorrection
(
    TrackData& td,
    const scalar dt,
    const label celli
...
template<class ParcelType>
template<class TrackData>
void Foam::DaemReactingMultiphaseParcel<ParcelType>::calc
(
    TrackData& td,
    const scalar dt,
    const label celli
)
{
    ...
    //Info << "Current rates: " << integratedDaemRates << endl;
    ...
    this->integratedDaemRates_ = tempIntegratedDaemRates;
    //Info << "The rates: " << this->integratedDaemRates << endl;
...
template<class ParcelType>
template<class TrackData>
void Foam::DaemReactingMultiphaseParcel<ParcelType>::calcDevolatilisation
(
    TrackData& td,
    const scalar dt,
    const scalar age,
...
template<class ParcelType>
template<class TrackData>
void Foam::DaemReactingMultiphaseParcel<ParcelType>::calcSurfaceReactions
(
    TrackData& td,
    const scalar dt,
    const label celli,
...
:
    ...
    integratedDaemRates_(p.integratedDaemRates_)
{
}
...
#include "DaemReactingMultiphaseParcelIO.C"
