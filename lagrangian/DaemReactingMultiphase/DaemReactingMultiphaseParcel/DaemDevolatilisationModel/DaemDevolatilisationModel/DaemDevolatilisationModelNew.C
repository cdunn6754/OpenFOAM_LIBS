...
Foam::autoPtr<Foam::DaemDevolatilisationModel<CloudType>>
Foam::DaemDevolatilisationModel<CloudType>::New
(
...
)
{
    ...
    return autoPtr<DaemDevolatilisationModel<CloudType>>(cstrIter()(dict, owner));
}
