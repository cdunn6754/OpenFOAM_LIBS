...
#include "SingleKineticRateDaemDevolatilisation.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class CloudType>
Foam::SingleKineticRateDaemDevolatilisation<CloudType>::
SingleKineticRateDaemDevolatilisation
(
...
SingleKineticRateDaemDevolatilisation
(
    const SingleKineticRateDaemDevolatilisation<CloudType>& dm
)
:
...
template<class CloudType>
void Foam::SingleKineticRateDaemDevolatilisation<CloudType>::calculate
(
    const scalar dt,
    const scalar age,
    const scalar mass0,
