...
const Foam::label Foam::NotionalParcel<ParcelType>::GAS(0);

template<class ParcelType>
const Foam::label Foam::NotionalParcel<ParcelType>::LIQ(1);

template<class ParcelType>
const Foam::label Foam::NotionalParcel<ParcelType>::SLD(2);
...
template<class ParcelType>
template<class TrackData>
void Foam::NotionalParcel<ParcelType>::setCellValues
(
    TrackData& td,
    const scalar dt,
    const label celli
...
template<class ParcelType>
template<class TrackData>
void Foam::NotionalParcel<ParcelType>::cellValueSourceCorrection
(
    TrackData& td,
    const scalar dt,
    const label celli
...
template<class ParcelType>
template<class TrackData>
void Foam::NotionalParcel<ParcelType>::calc
(
    TrackData& td,
    const scalar dt,
    const label celli
