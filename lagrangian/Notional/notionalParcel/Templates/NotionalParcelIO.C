...
Foam::string Foam::NotionalParcel<ParcelType>::propertyList_ =
    Foam::NotionalParcel<ParcelType>::propertyList();

template<class ParcelType>
const std::size_t Foam::NotionalParcel<ParcelType>::sizeofFields_
(
    0
);
...
template<class ParcelType>
Foam::NotionalParcel<ParcelType>::NotionalParcel
(
    const polyMesh& mesh,
    Istream& is,
    bool readFields
    ...
    canCombust_(0)
{
    ...
    is.check
    (
        "NotionalParcel<ParcelType>::NotionalParcel"
        "("
            "const polyMesh&, "
            "Istream&, "
            "bool"
...
void Foam::NotionalParcel<ParcelType>::readFields(CloudType& c)
{
    if (!c.size())
    {
        return;
...
void Foam::NotionalParcel<ParcelType>::readFields
(
    CloudType& c,
...
template<class ParcelType>
template<class CloudType>
void Foam::NotionalParcel<ParcelType>::writeFields(const CloudType& c)
{
...
template<class ParcelType>
template<class CloudType, class CompositionType>
void Foam::NotionalParcel<ParcelType>::writeFields
(
    const CloudType& c,
    const CompositionType& compModel
)
...
)
{
    ...
    (
        ...
        "("
            "Ostream&, "
            "const NotionalParcel<ParcelType>&"
        ")"
    );
