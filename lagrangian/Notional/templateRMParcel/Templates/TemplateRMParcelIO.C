...
Foam::string Foam::TemplateRMParcel<ParcelType>::propertyList_ =
    Foam::TemplateRMParcel<ParcelType>::propertyList();

template<class ParcelType>
const std::size_t Foam::TemplateRMParcel<ParcelType>::sizeofFields_
(
    0
);
    ...
    canCombust_(0)
{
    ...
    is.check
    (
        "TemplateRMParcel<ParcelType>::TemplateRMParcel"
        "("
            "const polyMesh&, "
            "Istream&, "
            "bool"
...
void Foam::TemplateRMParcel<ParcelType>::readFields(CloudType& c)
{
    if (!c.size())
    {
        return;
...
void Foam::TemplateRMParcel<ParcelType>::readFields
(
    CloudType& c,
...
)
{
    ...
    forAllIter(typename Cloud<TemplateRMParcel<ParcelType>>, c, iter)
    {
        TemplateRMParcel<ParcelType>& p = iter();
    ...
    forAll(gasNames, j)
    {
        ...
        forAllIter
        (
            typename Cloud<TemplateRMParcel<ParcelType>>,
            c,
            iter
        )
        {
...
template<class ParcelType>
template<class CloudType>
void Foam::TemplateRMParcel<ParcelType>::writeFields(const CloudType& c)
{
...
template<class ParcelType>
template<class CloudType, class CompositionType>
void Foam::TemplateRMParcel<ParcelType>::writeFields
(
    const CloudType& c,
    const CompositionType& compModel
)
{
    ...
    if (np > 0)
    {
        ...
        forAll(gasNames, j)
        {
            ...
            {
                const TemplateRMParcel<ParcelType>& p0 = iter();
...
)
{
    ...
    (
        ...
        "("
            "Ostream&, "
            "const TemplateRMParcel<ParcelType>&"
        ")"
    );
