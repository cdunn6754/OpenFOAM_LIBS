...
const Foam::label Foam::TemplateRMParcel<ParcelType>::GAS(0);

template<class ParcelType>
const Foam::label Foam::TemplateRMParcel<ParcelType>::LIQ(1);

template<class ParcelType>
const Foam::label Foam::TemplateRMParcel<ParcelType>::SLD(2);
...
Foam::scalar Foam::TemplateRMParcel<ParcelType>::CpEff
(
    TrackData& td,
    const scalar p,
    const scalar T,
...
template<class ParcelType>
template<class TrackData>
Foam::scalar Foam::TemplateRMParcel<ParcelType>::HsEff
(
    TrackData& td,
    const scalar p,
    const scalar T,
...
template<class ParcelType>
template<class TrackData>
Foam::scalar Foam::TemplateRMParcel<ParcelType>::LEff
(
    TrackData& td,
    const scalar p,
    const scalar T,
...
template<class ParcelType>
Foam::scalar Foam::TemplateRMParcel<ParcelType>::updateMassFractions
(
    const scalar mass0,
...
template<class ParcelType>
template<class TrackData>
void Foam::TemplateRMParcel<ParcelType>::setCellValues
(
    TrackData& td,
    const scalar dt,
    const label celli
...
template<class ParcelType>
template<class TrackData>
void Foam::TemplateRMParcel<ParcelType>::cellValueSourceCorrection
(
    TrackData& td,
    const scalar dt,
    const label celli
...
template<class ParcelType>
template<class TrackData>
void Foam::TemplateRMParcel<ParcelType>::calc
(
    TrackData& td,
    const scalar dt,
    const label celli
...
template<class ParcelType>
template<class TrackData>
void Foam::TemplateRMParcel<ParcelType>::calcDevolatilisation
(
    TrackData& td,
    const scalar dt,
    const scalar age,
...
template<class ParcelType>
template<class TrackData>
void Foam::TemplateRMParcel<ParcelType>::calcSurfaceReactions
(
    TrackData& td,
    const scalar dt,
    const label celli,
...
template<class ParcelType>
Foam::TemplateRMParcel<ParcelType>::TemplateRMParcel
(
    const TemplateRMParcel<ParcelType>& p
)
:
    ParcelType(p),
    YGas_(p.YGas_),
